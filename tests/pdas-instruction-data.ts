...
import { PdasInstructionData } from "../target/types/pdas_instruction_data";
import { getStringForInstruction } from "./utils";
...
describe("pdas-instruction-data", () => {
  ...
  const program = anchor.workspace
    .PdasInstructionData as Program<PdasInstructionData>;
